...
if [ -e "/sys/devices/f9924000.i2c/i2c-2/2-005d/keypad_enable" ]; then
	chown system:system /sys/devices/f9924000.i2c/i2c-2/2-005d/keypad_enable
	ln -s /sys/devices/f9924000.i2c/i2c-2/2-005d/keypad_enable /data/tp/keypad_enable
fi
